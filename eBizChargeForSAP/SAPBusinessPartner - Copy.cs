...
partial class SAP
{
    ...
    private void BusinessPartnerFormHandler2(SAPbouiCOM.Form form, SAPbouiCOM.ItemEvent pVal)
    {
        try
        {
            ...
            btn_TransactionLog1 = ((SAPbouiCOM.Button)(form.Items.Item("btnTrn1").Specific));
            Btn_paymentmethod2 = ((SAPbouiCOM.Button)(form.Items.Item("btnPM2").Specific));
            btn_TransactionLog2 = ((SAPbouiCOM.Button)(form.Items.Item("btnTrn2").Specific));
            TabEbiz = ((SAPbouiCOM.Folder)(form.Items.Item("tab1").Specific));
            SAPbouiCOM.Folder F0 = ((SAPbouiCOM.Folder)(form.Items.Item("tab1").Specific));
            F0.GroupWith("156");
    ...
    private string populateCustFromDB(SAPbouiCOM.Form form)
    {
        ...
        try
        {
            ...
            sql = string.Format("Select a.\"CardName\",b.\"Street\",b.\"City\",b.\"State\",b.\"ZipCode\",a.\"E_Mail\" from OCRD a, CRD1 b where a.\"CardCode\" = b.\"CardCode\" and a.\"BillToDef\" = b.\"Address\" and a.\"CardCode\"='{0}'", cardcode);
